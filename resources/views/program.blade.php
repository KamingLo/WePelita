...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-24 text-gray-800">
    ...
    <section class="space-y-6">
        ...
        <div class="space-y-8">
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-blue-600">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-green-600">
                <div class="flex items-center space-x-3 mb-4">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-purple-600">
                <div class="flex items-center space-x-3 mb-4">

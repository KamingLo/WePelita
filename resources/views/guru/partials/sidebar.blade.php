...
<body class="min-h-screen">
    <!-- Mobile Navigation -->
    <nav class="lg:hidden fixed top-0 left-0 right-0 z-50 floating-nav" style="margin-bottom: 20rem;">
        ...
        <div id="mobile-menu" class="absolute top-full left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-white/10 transform -translate-y-full opacity-0 transition-all duration-300 pointer-events-none">
            <div class="p-4 space-y-2">
                <a href="{{ route('guru.dashboard') }}" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-200 text-white nav-item {{ request()->is('guru/dashboard*') ? 'active-nav' : '' }}">
                    <i class="fas fa-home w-5 text-center"></i>
                    <span>Halaman Utama</span>
                </a>
                
                <div class="my-4">
                    <h5 class="text-amber-400 font-semibold text-sm uppercase tracking-wide px-3 mb-2">Guru Tools</h5>
                    <div class="space-y-1">
                        <a href="{{ route('guru.jadwal') }}" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-200 text-white nav-item {{ request()->is('guru/jadwal') ? 'active-nav' : '' }}">
                            <i class="fas fa-calendar-days w-5 text-center"></i>
                            <span>Lihat Jadwal Pelajaran</span>
                        </a>
                        <a href="{{ route('guru.jadwalanda') }}" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-200 text-white nav-item {{ request()->is('guru/jadwalanda*') ? 'active-nav' : '' }}">
                            <i class="fas fa-calendar-check w-5 text-center"></i>
                            <span>Lihat Jadwal Ajar Anda</span>
                        </a>
                        <a href="{{ route('guru.isinilai') }}" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-200 text-white nav-item {{ request()->is('guru/menu-nilai*') ? 'active-nav' : '' }}">
                            <i class="fas fa-scroll w-5 text-center"></i>
                            <span>Menu Nilai</span>
                        </a>
                        <a href="{{ route('guru.ManajemenPost') }}" class="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-200 text-white nav-item {{ request()->is('guru/ManajemenPost*') ? 'active-nav' : '' }}">
                ...
                <div class="border-t border-white/10 pt-4">
                    <!-- Toggle Dark/Light Mode di Mobile -->
    ...
    <aside id="sidebar" class="hidden lg:flex fixed top-0 left-0 h-full sidebar-transition z-40 flex-col bg-gradient-to-b from-slate-800 to-slate-900 shadow-2xl border-r border-white/10">
        ...
        <nav class="flex-1 p-4 custom-scrollbar overflow-y-auto">
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('guru.dashboard') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 nav-item group {{ request()->is('guru/dashboard*') ? 'active-nav' : 'hover:bg-white/10 text-white' }}">
                ...
                <li class="pt-4">
                    <h5 class="text-amber-400 font-semibold text-sm uppercase tracking-wide px-3 mb-3 sidebar-text">Guru Tools</h5>
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('guru.jadwal') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 nav-item group {{ request()->is('guru/jadwal') ? 'active-nav' : 'hover:bg-white/10 text-white' }}">
                                <i class="fas fa-calendar-days w-5 text-center group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="sidebar-text font-medium">Lihat Jadwal Pelajaran</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('guru.jadwalanda') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 nav-item group {{ request()->is('guru/jadwalanda*') ? 'active-nav' : 'hover:bg-white/10 text-white' }}">
                                <i class="fas fa-calendar-check w-5 text-center group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="sidebar-text font-medium">Lihat Jadwal Ajar Anda</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('guru.isinilai') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 nav-item group {{ request()->is('guru/menu-nilai*') ? 'active-nav' : 'hover:bg-white/10 text-white' }}">
                                <i class="fas fa-scroll w-5 text-center group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="sidebar-text font-medium">Menu Nilai</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('guru.ManajemenPost') }}" class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 nav-item group {{ request()->is('guru/ManajemenPost*') ? 'active-nav' : 'hover:bg-white/10 text-white' }}">
        ...
        <div class="p-4 border-t border-white/10">
            <!-- Toggle Dark/Light Mode di Desktop -->

...
<div class="ml-0 lg:ml-64 p-4 sm:p-4 flex flex-col gap-4 sm:gap-8 transform translate-y-0 sm:translate-y-0 min-h-screen pt-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 -mt-5">
        <a href="{{ route('orangtua.jadwal') }}" class="bg-white p-4 sm:p-5 rounded-lg shadow-md text-center text-gray-800 hover:-translate-y-1 hover:shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="text-xs sm:text-sm text-gray-500">View your child's class schedule</p>
        </a>
        <a href="{{ route('orangtua.nilai') }}" class="bg-white p-4 sm:p-5 rounded-lg shadow-md text-center text-gray-800 hover:-translate-y-1 hover:shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
            <div class="text-3xl sm:text-4xl text-blue-500 mb-3 sm:mb-4"><i class="fa-solid fa-scroll"></i></div>
            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2">Nilai Anak</h3>
            <p class="text-xs sm:text-sm text-gray-500">Check your child's grades</p>
        </a>
        <a href="{{ route('orangtua.pengumuman') }}" class="bg-white p-4 sm:p-5 rounded-lg shadow-md text-center text-gray-800 hover:-translate-y-1 hover:shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
            ...
            <p class="text-xs sm:text-sm text-gray-500">View all announcements</p>
        </a>
    </div>

            ...
            <ul class="py-2">
                <li class="mb-1">
                    <a href="{{ route('orangtua.dashboard') }}"
                       class="block px-4 py-2 text-white hover:bg-gray-800 transition-colors duration-200 {{ request()->is('orangtua/dashboard*') || request()->is('profile*') ? 'bg-yellow-300 text-gray-900' : '' }}">
                        <i class="fa-solid fa-house mr-3"></i>Halaman Utama
                    </a>
                </li>
                <li class="border-b border-gray-800 my-1"></li>
                <h5 class="px-4 py-2 text-gray-400 font-medium">Parent Tools</h5>
                <li class="mb-1">
                    <a href="{{ route('orangtua.jadwal') }}"
                       class="block px-4 py-2 text-white hover:bg-gray-800 transition-colors duration-200 {{ request()->is('orangtua/jadwal*') ? 'bg-yellow-300 text-gray-900' : '' }}">
                        <i class="fa-solid fa-calendar-days mr-3"></i>Jadwal Kelas
                    </a>
                </li>
                <li class="mb-1" style="margin-top: 4px;">
                    <a href="{{ route('orangtua.nilai') }}"
                       class="block px-4 py-2 text-white hover:bg-gray-800 transition-colors duration-200 {{ request()->is('orangtua/nilai*') ? 'bg-yellow-300 text-gray-900' : '' }}">
                        <i class="fa-solid fa-scroll mr-3"></i>Nilai Anak
                    </a>
                </li>
                <li class="mb-1" style="margin-top: 4px;">
                    <a href="{{ route('orangtua.pengumuman') }}"
                       class="block px-4 py-2 text-white hover:bg-gray-800 transition-colors duration-200 {{ request()->is('orangtua/pengumuman*') ? 'bg-yellow-300 text-gray-900' : '' }}">
    ...
    <aside class="fixed top-0 left-0 h-full w-64 flex flex-col bg-gray-900 text-white p-6 transition-all duration-400 ease-in-out overflow-x-hidden group lg:flex hidden" style="z-index: 49;">
        <div class="flex flex-col items-start mb-6">
            <div class="flex items-center mb-2">
                ...
                <div>
                    <h3 class="text-xl font-semibold whitespace-nowrap ml-4 text-white" id="Sapaan">Selamat Sore</h3>
        ...
        <ul class="flex-1 mt-2 overflow-y-auto custom-scrollbar">
            ...
            <li class="mb-1">
                <a href="{{ route('orangtua.dashboard') }}"
                   class="flex items-center gap-5 p-4 rounded-lg transition-all duration-200 ease-in-out
                          ...
                          {{ request()->is('orangtua/dashboard*') || request()->is('profile*') ? 'bg-yellow-300 text-gray-900 shadow-md' : 'text-white font-normal' }}">
            ...
            <li class="mb-1">
                <a href="{{ route('orangtua.jadwal') }}"
                   class="flex items-center gap-5 p-4 rounded-lg transition-all duration-200 ease-in-out
                          hover:bg-white hover:text-black hover:shadow-lg
                          {{ request()->is('orangtua/jadwal*') ? 'bg-yellow-300 text-gray-900 shadow-md' : 'text-white font-normal' }}">
            ...
            <li class="mb-1" style="margin-top: 4px;">
                <a href="{{ route('orangtua.nilai') }}"
                   class="flex items-center gap-5 p-4 rounded-lg transition-all duration-200 ease-in-out
                          hover:bg-white hover:text-black hover:shadow-lg
                          {{ request()->is('orangtua/nilai*') ? 'bg-yellow-300 text-gray-900 shadow-md' : 'text-white font-normal' }}">
                    <i class="fa-solid fa-scroll text-2xl w-8 text-center"></i>Nilai Anak
                </a>
            </li>
            ...
            <li class="mb-1" style="margin-top: 4px;">
                <a href="{{ route('orangtua.pengumuman') }}"
                   class="flex items-center gap-5 p-4 rounded-lg transition-all duration-200 ease-in-out
                          hover:bg-white hover:text-black hover:shadow-lg
                          {{ request()->is('orangtua/pengumuman*') ? 'bg-yellow-300 text-gray-900 shadow-md' : 'text-white font-normal' }}">

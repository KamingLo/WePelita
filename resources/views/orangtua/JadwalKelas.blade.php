            ...
            <div class="flex flex-col md:flex-row md:items-center mb-5">
                ...
                <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <div class="flex flex-row gap-4 w-full">
                        <a href="{{ route('orangtua.export-jadwal') }}" class="inline-block px-10 py-2 bg-green-600 border border-green-600 text-white rounded-md transition duration-300 ease-in-out hover:bg-green-700 hover:border-green-700 w-full md:w-auto text-center h-10 flex items-center justify-center min-w-[190px]">Unduh Jadwal</a>

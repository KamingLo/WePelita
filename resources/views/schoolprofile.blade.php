        ...
        <section class="py-12">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 md:gap-8" data-aos="fade-up">
                <div class="flex-1 text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed space-y-4 text-justify">
                    ...
                    <p>
                        Atas nama Yayasan Pendidikan Budi Bhakti, saya menyampaikan apresiasi dan terima kasih yang setinggi-tingginya kepada para orang tua yang telah mempercayakan pendidikan putra-putrinya kepada SMK Pelita IV. Ucapan terima kasih juga saya sampaikan kepada seluruh guru dan staf yang dengan penuh dedikasi membimbing, mendidik, dan menjadi teladan bagi para siswa di sekolah tercinta ini.
                    </p>
                    <p>
                        Kita semua menyadari, tantangan pendidikan di era ini semakin kompleks. Arus globalisasi, penyalahgunaan teknologi, pergaulan bebas, serta menurunnya nilai-nilai moral menjadi perhatian kita bersama. Karena itu, SMK Pelita IV berkomitmen untuk tidak hanya memberikan pendidikan akademis dan keterampilan kejuruan, tetapi juga menanamkan pendidikan karakter yang berlandaskan nilai iman, kejujuran, tanggung jawab, integritas, dan kerja keras.
                    </p>
                    <p>
                        SMK Pelita IV memiliki tiga jurusan unggulan, yaitu:
                    </p>
                    <ul class="list-disc pl-5">
                        <li class="mb-2">Desain Komunikasi Visual (DKV) – membekali siswa dengan kreativitas dan keterampilan di bidang desain dan industri kreatif.</li>
                        <li class="mb-2">Akuntansi – mengajarkan keahlian dalam pengelolaan keuangan yang akurat dan profesional.</li>
                        <li class="mb-2">Otomatisasi dan Tata Kelola Perkantoran (OKP) – menyiapkan tenaga administrasi yang siap kerja, terampil, dan berintegritas.</li>
                    </ul>
                    <p>
                        Kami percaya, melalui kurikulum terintegrasi dan program unggulan seperti magang industri, workshop, pelatihan, dan pengembangan wirausaha, lulusan SMK Pelita IV akan siap menghadapi dunia kerja maupun melanjutkan studi ke jenjang yang lebih tinggi.
                    </p>
                    <p>
                        Akhir kata, kami berharap SMK Pelita IV terus menjadi sekolah yang mencetak generasi muda yang kreatif, profesional, dan berakhlak mulia. Semoga kerja sama antara sekolah, orang tua, dan masyarakat semakin kuat demi tercapainya cita-cita besar kita bersama: mempersiapkan anak-anak bangsa untuk masa depan yang gemilang.
                    </p>
